  ...
  return (
    <div className="flex flex-col bg-white overflow-hidden" style={{ width: "17%", opacity: 10 }}>
      ...
      <ul className="flex flex-col py-10 px-8">
        <li className='py-2'>
          <Link to="/adminPage/dashboard" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
        ...
        <li className='py-2'>
          <Link to="/adminPage/application" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
              <svg className="w-6 h-6" viewBox="0 0 24 24">
        ...
        <li className='py-2'>
          <Link to='/adminPage/history' className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
            <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
              <svg className="w-6 h-6" viewBox="0 0 24 24">
